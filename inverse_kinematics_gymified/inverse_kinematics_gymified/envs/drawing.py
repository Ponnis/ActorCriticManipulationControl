...
def drawOrientation(ax, orientation, t_v):
...
def drawPoint(ax, p, color_inside):    
    ax.plot([p[0]], [p[1]], [p[2]], markerfacecolor=color_inside, markeredgecolor='r', marker='o', markersize=5.5, alpha=0.9)
